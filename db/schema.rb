...
ActiveRecord::Schema.define(version: 20160122202007) do
  ...
  add_index "timekeepings", ["project_id"], name: "index_timekeepings_on_project_id"
  add_index "timekeepings", ["user_id"], name: "index_timekeepings_on_user_id"
